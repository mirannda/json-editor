JSONEditor.defaults.themes.tailwind = JSONEditor.AbstractTheme.extend({
  ...
  getFormControl: function(label, input, description) {
    ...
    if (label && input.type === "checkbox") {
      ...
      label.classList.add("block", "mt-0", "text-sm");
      group.appendChild(label);
      input.classList.add("relative", "float-left");
    } else {
      group.classList.add("form-group", "mb-3");
      if (label) {
        label.classList.add("block", "text-black", "mb-2");
        group.appendChild(label);
      }
  ...
  getTable: function() {
    ...
    el.classList.add("border", "w-auto", "p-1");
    return el;
  },
  ...
  addInputError: function(input, text) {
    ...
    if (!input.errmsg) {
      ...
      input.errmsg.classList.add("block", "mt-1", "text-sm", "text-red");
  ...
  removeInputError: function(input) {
    ...
    input.errmsg.style.display = "hidden"; //none
  ...
  getInputGroup: function(input, buttons) {
    ...
    inputGroup.classList.add("-mr-1"); //input-group-prepend
